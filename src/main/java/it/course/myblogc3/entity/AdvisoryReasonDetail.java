...
public class AdvisoryReasonDetail implements Serializable{
	...
	public AdvisoryReasonDetail(AdvisoryReasonDetailId advisoryReasonDetailId, AdvisorySeverity advisorySeverity) {
		super();
		this.advisoryReasonDetailId = advisoryReasonDetailId;
